...
function draw() {
    ...
    fill("black")
    text("USE MOUSE TOO MOVE AROUND", windowWidth/2, windowHeight/8);
    text("CLICK TOO SHOOT", windowWidth/2, windowHeight/7);
    text("HOLD [C] TO ZOOM IN", windowWidth/2, windowHeight/6);
